...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wx619521750/CommonTools.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Carlo' => 'carlo_wang@sdmctech.com' }
  s.source           = { :git => 'https://github.com/wx619521750/CommonTools.git', :tag => s.version.to_s }
